...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.order'
        db.alter_column('jobs_job', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Job.order'
        raise RuntimeError("Cannot reverse this migration. 'Job.order' and its values cannot be restored.")
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
