...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field followers on 'Task'
        db.create_table('jobs_task_followers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm['jobs.task'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('jobs_task_followers', ['task_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field followers on 'Task'
        db.delete_table('jobs_task_followers')
