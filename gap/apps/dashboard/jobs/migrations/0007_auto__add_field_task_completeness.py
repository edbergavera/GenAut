...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.completeness'
        db.add_column('jobs_task', 'completeness',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.completeness'
        db.delete_column('jobs_task', 'completeness')
    ...
    models = {
        ...
        'jobs.commontaskdescription': {
            'Meta': {'object_name': 'CommonTaskDescription'},
        ...
        'jobs.task': {
            ...
            'completeness': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
