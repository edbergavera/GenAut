...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Price.min_tpl_price'
        db.add_column('pricelist_price', 'min_tpl_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Price.min_rpl_price'
        db.add_column('pricelist_price', 'min_rpl_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Price.min_tpl_price'
        db.delete_column('pricelist_price', 'min_tpl_price')

        # Deleting field 'Price.min_rpl_price'
        db.delete_column('pricelist_price', 'min_rpl_price')
