...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Stage', fields ['name']
        db.create_unique('jobs_stage', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Stage', fields ['name']
        db.delete_unique('jobs_stage', ['name'])
