...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CsvRow'
        db.create_table('pricelist_csvrow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity_discount', self.gf('django.db.models.fields.TextField')()),
            ('base_tpl_price', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3)),
            ('base_rpl_price', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3)),
        ))
        db.send_create_signal('pricelist', ['CsvRow'])

        # Adding field 'Price.csv'
        db.add_column('pricelist_price', 'csv',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='prices', null=True, to=orm['pricelist.CsvRow']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CsvRow'
        db.delete_table('pricelist_csvrow')

        # Deleting field 'Price.csv'
        db.delete_column('pricelist_price', 'csv_id')
    ...
    models = {
        ...
        'pricelist.price': {
            ...
            'min_area': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            ...
            'quantity': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
