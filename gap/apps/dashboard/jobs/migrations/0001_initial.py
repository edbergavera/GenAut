...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('jobs_job', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_creator', to=orm['auth.User'])),
        ))
        db.send_create_signal('jobs', ['Job'])

        # Adding model 'Task'
        db.create_table('jobs_task', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.Job'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_creator', null=True, to=orm['auth.User'])),
            ('stage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.Stage'], null=True, blank=True)),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignet_to', null=True, to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('jobs', ['Task'])

        # Adding model 'Stage'
        db.create_table('jobs_stage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('related_status', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('jobs', ['Stage'])

        # Adding M2M table for field jobs on 'Stage'
        db.create_table('jobs_stage_jobs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('stage', models.ForeignKey(orm['jobs.stage'], null=False)),
            ('job', models.ForeignKey(orm['jobs.job'], null=False))
        ))
        db.create_unique('jobs_stage_jobs', ['stage_id', 'job_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Task'
        db.delete_table('jobs_task')

        # Deleting model 'Stage'
        db.delete_table('jobs_stage')

        # Removing M2M table for field jobs on 'Stage'
        db.delete_table('jobs_stage_jobs')
    ...
    models = {
        ...
        'jobs.stage': {
            ...
            'jobs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['jobs.Job']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'related_status': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'jobs.task': {
            'Meta': {'object_name': 'Task'},
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assignet_to'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'priority': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'stage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['jobs.Stage']", 'null': 'True', 'blank': 'True'}),
