...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Price.rpl_price'
        db.alter_column('pricelist_price', 'rpl_price', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))

        # Changing field 'Price.tpl_price'
        db.alter_column('pricelist_price', 'tpl_price', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Price.rpl_price'
        db.alter_column('pricelist_price', 'rpl_price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Price.tpl_price'
        db.alter_column('pricelist_price', 'tpl_price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
