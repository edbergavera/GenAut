...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommonTaskDescription'
        db.create_table('jobs_commontaskdescription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('jobs', ['CommonTaskDescription'])


    def backwards(self, orm):
        # Deleting model 'CommonTaskDescription'
        db.delete_table('jobs_commontaskdescription')
