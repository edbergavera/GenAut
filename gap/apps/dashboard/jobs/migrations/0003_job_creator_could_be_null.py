...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('jobs_job', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Job.creator'
        db.alter_column('jobs_job', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User']))
