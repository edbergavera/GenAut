...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Line.items_required'
        db.alter_column('basket_line', 'items_required', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Line.items_required'
        # setting default to 0
        db.alter_column('basket_line', 'items_required', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        'basket.line': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items_required': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
