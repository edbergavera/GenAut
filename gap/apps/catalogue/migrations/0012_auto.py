...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field value_multi_option on 'ProductAttributeValue'
        db.delete_table('catalogue_productattributevalue_value_multi_option')


    def backwards(self, orm):
        # Adding M2M table for field value_multi_option on 'ProductAttributeValue'
        db.create_table('catalogue_productattributevalue_value_multi_option', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productattributevalue', models.ForeignKey(orm['catalogue.productattributevalue'], null=False)),
            ('attributeoption', models.ForeignKey(orm['catalogue.attributeoption'], null=False))
        ))
        db.create_unique('catalogue_productattributevalue_value_multi_option', ['productattributevalue_id', 'attributeoption_id'])
