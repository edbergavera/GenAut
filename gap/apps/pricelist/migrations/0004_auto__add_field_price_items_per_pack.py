...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Price.items_per_pack'
        db.add_column('pricelist_price', 'items_per_pack',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Price.items_per_pack'
        db.delete_column('pricelist_price', 'items_per_pack')
