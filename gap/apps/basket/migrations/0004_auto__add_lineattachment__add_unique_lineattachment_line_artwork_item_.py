...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LineAttachment'
        db.create_table('basket_lineattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('line', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['basket.Line'])),
            ('artwork_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['options.ArtworkItem'])),
        ))
        db.send_create_signal('basket', ['LineAttachment'])

        # Adding unique constraint on 'LineAttachment', fields ['line', 'artwork_item']
        db.create_unique('basket_lineattachment', ['line_id', 'artwork_item_id'])
        ...
        # Adding field 'Line.pricing_group'
        db.add_column('basket_line', 'pricing_group',
                      self.gf('django.db.models.fields.CharField')(default='retail', max_length=30),
                      keep_default=False)

        # Adding field 'LineAttribute.data'
        db.add_column('basket_lineattribute', 'data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'LineAttribute.value_code'
        db.add_column('basket_lineattribute', 'value_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LineAttachment', fields ['line', 'artwork_item']
        db.delete_unique('basket_lineattachment', ['line_id', 'artwork_item_id'])

        # Deleting model 'LineAttachment'
        db.delete_table('basket_lineattachment')

        # Deleting field 'Line.stockrecord_source'
        db.delete_column('basket_line', 'stockrecord_source')

        # Deleting field 'Line.pricing_group'
        db.delete_column('basket_line', 'pricing_group')

        # Deleting field 'LineAttribute.data'
        db.delete_column('basket_lineattribute', 'data')

        # Deleting field 'LineAttribute.value_code'
        db.delete_column('basket_lineattribute', 'value_code')
    ...
    models = {
        ...
        'basket.line': {
            ...
            'pricing_group': ('django.db.models.fields.CharField', [], {'default': "'retail'", 'max_length': '30'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'basket_lines'", 'to': "orm['catalogue.Product']"}),
            'quantity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'stockrecord_source': ('django.db.models.fields.CharField', [], {'default': "'stockrecord'", 'max_length': '30'})
        },
        'basket.lineattachment': {
            'Meta': {'unique_together': "(('line', 'artwork_item'),)", 'object_name': 'LineAttachment'},
            'artwork_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['options.ArtworkItem']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'catalogue.productattributevalue': {
            ...
            'value_multi_option': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'multi_option'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalogue.AttributeOption']"}),
